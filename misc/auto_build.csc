...
function build_compile(module_name, source_path, cxx_opts)
    ...
    system.run("g++ -std=c++17 --shared -fPIC -O2 -DNDEBUG -Wno-deprecated-declarations -I\"" + csdev_path + system.path.separator + "include\" \"" + source_path + "\" -L\"" + csdev_path + system.path.separator + "lib\" -lcovscript -o " + base_path + file_name.str(1) + ".cse " + cxx_opts)
end
