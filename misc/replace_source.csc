import regex
var url_reg = regex.build("^(.*)http://mirrors\\.covariant\\.cn/cspkg/index\\.json(.*)$")
...
loop
    ...
    if !match.empty()
        ...
        file_data.push_back(match.str(1) + "http://mirrors.covariant.cn/cspkg_nightly/index.json" + match.str(2))
    else
